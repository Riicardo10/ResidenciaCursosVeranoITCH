...
<?php
	...
	$jefes = new JefeModel; 
	$listaJefes = $jefes->getListaJefes();
	$obj_area = new AreaModel; 
?>
<div class="col panel panel-success col-lg-offset-0">
	<div class="panel-heading text-center">
		<h3 >Lista de Jefes de Departamento</h3>
	</div>
	<div class="panel-body ">
		<a href="../jefes/agregar.php"><img src="../img/mas.png" alt="" style="float: right;" title="Agregar" ></a>
		<table class="table">
			<thead>
				<tr>
					<th>Clave</th>
			...
			<tbody>
				<?php  
					if ( $listaJefes ){
						while($row = $listaJefes->fetch_assoc()) { ?>
							<tr>
								...
								?> </td>
								<td>
									<a class="btn btn-primary" href="../jefes/actualizar.php?clave=<?php echo $row['clave']; ?>">Actualizar</a>
								</td>
								<td>
									 <form action="../jefes/JefeModel.php" method="POST">
