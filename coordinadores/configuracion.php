		...
		<div class="row">
			<div class="col panel panel-success col-lg-13 col-lg-offset-0">
				<div class="panel-heading text-center">
					<h1 >Configuración del coordinador</h1>
				</div>
				<div class="panel-body ">
					<form action="CoordinadorModel.php" method="POST">
						<div class="form-group text-center">
							<label for="txt_no_control" style="text-align: left; font-size: 20px;width: 200px;">Numero de control:</label>
							<input type="text" name="txt_no_control" style="width: 200px; font-size: 20px" value="<?php echo $no_control; ?>" readonly>
						</div>
						<div class="form-group text-center">
