...
<html>
	<head>
		<title>Registro de Coordinadores de Materia</title>
			...
			<div class="row">
				<div class="col panel panel-success col-lg-13 col-lg-offset-0">
					<div class="panel-heading text-center">
						<h1 >Registro de Coordinadores de Materia</h1>
					</div>
						...
						<form action="CoordinadorModel.php" method="POST">
							<div class="row form-group text-center">
								<div class="col-xs-10">
									...
									<input type="text" name="txt_numero_control" style="width: 200px; font-size: 20px">
								</div>
							</div>
							<div class="row form-group text-center">
								<div class="col-xs-4">
